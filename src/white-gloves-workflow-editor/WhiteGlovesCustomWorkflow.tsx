...
import ReactFlow, { addEdge, Background, BackgroundVariant, Controls, Edge, getConnectedEdges, getIncomers, getOutgoers, MiniMap, Node, OnConnect, OnConnectEnd, OnConnectStart, OnEdgeUpdateFunc, OnNodesDelete, OnSelectionChangeFunc, ReactFlowInstance, ReactFlowProvider, updateEdge, useEdgesState, useNodesState, useReactFlow } from 'reactflow';
...
import { deadEndNodeIdsState, Flag, flagState, selectedEdgeIdsState, selectedNodeIdsState, selectedProcessConnectionState, tipsClosedState, visitedIdsState } from './states';
import './styles.scss';
import { Action, ProcessConnection, Stage, Type } from './types';
import { CanvasComponentV2 } from './CanvasComponent';
...
const WORKFLOW_JSON = {
  nodes: [
    { width: 125, height: 25, id: 'f836a322-ae52-426f-9b16-afe26f498497', data: { label: 'Migration complete', type: 'DONE' }, position: { x: 100, y: 1625 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 100, y: 1625 } },
    { width: 195, height: 25, id: 'c0043690-e7ca-4416-b6d7-ed8e6993bd1d', data: { label: 'GoLive test load requested', type: 'AWAITING_REPLY' }, position: { x: 500, y: 1550 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 500, y: 1550 } },
    { width: 125, height: 25, id: 'c9213646-e31a-4a00-a177-df5936641146', data: { label: 'GoLive', type: 'NORMAL' }, position: { x: 100, y: 1475 }, type: 'CustomNode', selected: false, positionAbsolute: { x: 100, y: 1475 } },
    { width: 191, height: 25, id: 'd1fbb329-ff28-4d00-adc0-eecb704c379a', data: { label: 'GoLive T-1 letter acknowledged', type: 'NORMAL' }, position: { x: 100, y: 1375 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 100, y: 1375 } },
    { width: 137, height: 25, id: 'cb2cd55a-8314-4639-8147-aa504d7e1d25', data: { label: 'GoLive T-1 letter sent', type: 'AWAITING_REPLY' }, position: { x: 100, y: 1275 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 100, y: 1275 } },
    { width: 191, height: 25, id: 'a8b091e1-daa3-42d0-980b-67b31be59759', data: { label: 'GoLive T-5 letter acknowledged', type: 'NORMAL' }, position: { x: 100, y: 1175 }, type: 'CustomNode', selected: false, positionAbsolute: { x: 100, y: 1175 }, dragging: false },
    { width: 167, height: 25, id: '81b21de4-e3b6-4674-b98b-fa3ba020a5dc', data: { label: 'GoLive T-5 letter sent', type: 'AWAITING_REPLY' }, position: { x: 100, y: 1075 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 100, y: 1075 } },
    { width: 197, height: 25, id: 'ef5d41a7-bc55-40a3-9872-d316a6c91ac1', data: { label: 'GoLive T-14 letter acknowledged', type: 'NORMAL' }, position: { x: 100, y: 975 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 100, y: 975 } },
    { width: 173, height: 25, id: '147325e2-0079-47f6-899a-f41a16ee2617', data: { label: 'GoLive T-14 letter sent', type: 'AWAITING_REPLY' }, position: { x: 100, y: 875 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 100, y: 875 } },
    { width: 220, height: 25, id: '31a5eb64-654b-4566-a2b0-39fa04da57be', data: { label: 'Additional connection info requested', type: 'AWAITING_REPLY' }, position: { x: -300, y: 612.5 }, type: 'CustomNode', selected: false, positionAbsolute: { x: -300, y: 612.5 }, dragging: false },
    { width: 191, height: 25, id: '09dbcd98-8e14-421f-b5bb-06ceb5671e5d', data: { label: 'Connection test date confirmed', type: 'NORMAL' }, position: { x: 487.5, y: 831.25 }, type: 'CustomNode', selected: false, positionAbsolute: { x: 487.5, y: 831.25 }, dragging: false },
    { width: 219, height: 25, id: '492b9012-1022-4e32-a2a8-15e97ec784ec', data: { label: 'Connection test date suggested', type: 'AWAITING_REPLY' }, position: { x: 950, y: 775 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 950, y: 775 } },
    { width: 125, height: 25, id: '3ec92d51-fda1-44e9-8cee-b95b4f02106a', data: { label: 'Connection OK', type: 'NORMAL' }, position: { x: 100, y: 725 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 100, y: 725 } },
    { width: 125, height: 25, id: '12fabbec-8c88-41c6-b8b9-2166b1332eae', data: { label: 'Connection failed', type: 'ERROR' }, position: { x: 487.5, y: 718.75 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 487.5, y: 718.75 } },
    { width: 184, height: 25, id: '5beb9d9d-815b-433f-834a-a21f5dd88a03', data: { label: 'Migration letter acknowledged', type: 'NORMAL' }, position: { x: 481.25, y: 475 }, type: 'CustomNode', selected: false, dragging: false, positionAbsolute: { x: 481.25, y: 475 } },
    { width: 155, height: 25, id: 'dd6b58f1-77cc-4a43-8b8a-31a778da785f', data: { label: 'Connection info received', type: 'NORMAL' }, position: { x: 100, y: 475 }, type: 'CustomNode', selected: false, positionAbsolute: { x: 100, y: 475 }, dragging: false },
    { width: 161, height: 25, id: '19a047d6-e432-41e6-bb5c-d4f9a480360f', data: { label: 'Migration letter sent', type: 'AWAITING_REPLY' }, position: { x: 100, y: 350 }, type: 'CustomNode', selected: false, positionAbsolute: { x: 100, y: 350 }, dragging: false },
    { width: 128, height: 25, id: '124b96ee-a903-4f23-a23e-802fcccbcabd', data: { label: 'Welcome email sent', type: 'NORMAL' }, position: { x: 100, y: 225 }, type: 'CustomNode', selected: false, positionAbsolute: { x: 100, y: 225 }, dragging: false },
    { width: 125, height: 25, id: '218c52b2-a362-45c1-902f-2a7d052e87d2', data: { label: 'Start', type: 'START' }, position: { x: 100, y: 100 }, type: 'CustomNode', positionAbsolute: { x: 100, y: 100 } },
  ],
  edges: [
...
const START_NODE: Node<Stage> = { id: v4(), data: { label: 'Start', type: Type.START }, position: { x: 200, y: 200 }, type: 'CustomNode' };

const CanvasComponent: React.FC = () => {
  //
  const ref = useRef<HTMLDivElement>(null);

  const { addNodes, screenToFlowPosition, setViewport } = useReactFlow<Stage, Action>();
  ...
  const [tipsClosed, setTipsClosed] = useRecoilState(tipsClosedState);
  ...
  const [nodes, setNodes, onNodesChange] = useNodesState<Stage>([START_NODE]);
  ...
  const onDoubleClick = useCallback(
    (ev: React.MouseEvent<HTMLDivElement>) => {
      ...
      setTipsClosed(value => (flag === Flag.FIRST_TIME ? false : value));
    },
    [addNodes, flag, screenToFlowPosition, setFlag, setTipsClosed],
  );
  ...
  const onSelectionChanged = useCallback<OnSelectionChangeFunc>(
    ({ nodes, edges }: { nodes: Node<Stage>[]; edges: Edge<Action>[] }) => {
    ...
    [flag, prevSelectedEdgesCount, prevSelectedNodesCount, setFlag, setSelectedEdgeIds, setSelectedNodeIds, setTipsClosed],
  );
  ...
  const onConnect = useCallback<OnConnect>(
    ({ source, target, sourceHandle, targetHandle }) => {
      ...
      setTipsClosed(value => (flag === Flag.STATE_CONFIGURED ? false : value));
    },
    [edges, flag, nodes, setEdges, setFlag, setTipsClosed],
  );

  const onConnectionStart = useCallback<OnConnectStart>((_ev, { nodeId }) => {
    connectingNodeId.current = nodeId;
  }, []);

  const onConnectionEnd = useCallback<OnConnectEnd>(
    (ev: any) => {
      if (!connectingNodeId.current) return;
      console.log(ev);
      const targetIsPane = ev.target.classList.contains('react-flow__pane');
      if (!targetIsPane) return;
      const newNode: Node<Stage> = {
        id: v4(),
        data: {
          label: uniqueId('Stage #'),
          type: Type.NORMAL,
      ...
      setEdges(edges => edges.concat({ id: v4(), source: connectingNodeId.current!, target: newNode.id }));
    },
  ...
  const [rfInstance, setRfInstance] = useState<ReactFlowInstance<Stage, Action> | null>(null);
  ...
  const load = useCallback(() => {
    ...
    restoreFlow();
  }, [setEdges, setFlag, setNodes, setTipsClosed, setViewport]);
  ...
  const clear = useCallback(() => {
    ...
    setTipsClosed(false);
  }, [setEdges, setFlag, setNodes, setTipsClosed]);
  ...
  return (
    <div className="white-gloves-workflow-editor" style={{ width: '100vw', height: '100vh' }}>
      ...
      >
        ...
        <Stack className="control-buttons" onDoubleClick={prevent} direction="column" spacing={1} style={{ marginTop: 8 }}>
        ...
        {!tipsClosed && (
          <div className="guided-tour">
            <IconButton size="small" className="close-button" onClick={() => setTipsClosed(true)}>
              <Close fontSize="small" />
            </IconButton>
            {flag === Flag.FIRST_TIME && (
              <>
                <p>
                  Welcome to the <b>White Gloves Workflow Editor</b>. Here we can create and configure workflows for White Gloves migration journey. A workflow consists of a collection of communication stages, connected by actions. The WG team can execute any of the outgoing actions from a stage.
                </p>
            ...
            {flag === Flag.STATE_CREATED && (
              <>
                <p>
                  Awesome! Now that we have a new communication stage, we can rename it as we please. We can also choose from one of our predefined stages by pressing the <b>Down Arrow</b> key in the name field. Communication stages can be one of several types:
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    <b>Normal</b>: This indicates that migration for a partner or process is progressing as expected.
                  </li>
                  <li>
